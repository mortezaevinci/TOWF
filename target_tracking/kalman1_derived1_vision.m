...
while (cl==0)
    ...
    armanalysis{camnum}.pinky=(imcap{camnum}.caprgb(:,:,1)>imcap{camnum}.caprgb(:,:,2)*1.7)&(imcap{camnum}.caprgb(:,:,1)>imcap{camnum}.caprgb(:,:,3)*1.7)&(imcap{camnum}.caprgb(:,:,3)<150);

    armanalysis{camnum}.pinky=medfilt2(armanalysis{camnum}.pinky,[7 7]);
