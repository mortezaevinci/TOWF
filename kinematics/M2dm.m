...
clear L
L{1} = link([ pi/2 .16	0	0	0], 'standard');
L{2} = link([-pi/2 	0	-pi/2	0	0], 'standard');
L{3} = link([pi/2 0 0 .18+.15  0],'standard');
L{4} = link([-pi/2 0 0 0  0],'standard');
L{5} = link([pi/2 0 0 .18+.12  0],'standard');
L{6} = link([-pi/2 .2 pi/2 0  0],'standard');
...
M2d = robot(L, 'M2 dale', 'Unimation', 'params of 8/95');
clear L
M2d.name = 'M2 dale';
M2d.manuf = 'Unimation';
