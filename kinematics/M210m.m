...
clear L
L{1} = link([ pi/2 .5	0	0	0], 'standard');
L{2} = link([0 	.8	0	0	0], 'standard');
L{3} = link([pi/2 .0 0 0  0],'standard');
L{4} = link([-pi/2 0 0 0  0],'standard');
L{5} = link([-pi/2 .5 0 0  0],'standard');
L{6} = link([0 .5 0 0  0],'standard');
L{7} = link([pi/2 .0 0 0  0],'standard');
L{8} = link([-pi/2 0 0 0  0],'standard');
L{9} = link([-pi/2 .5 0 0  0],'standard');
L{10} = link([0 .5 0 0  0],'standard');
