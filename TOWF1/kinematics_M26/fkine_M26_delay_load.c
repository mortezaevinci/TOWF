 ...
 */
FARPROC WINAPI fkine_M26DelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = fkine_M26DelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = fkine_M26DelayLoadWin32FailureHook;
#endif
