...
recompute_extrinsic = (length(calibparams.n_img) < 100); % if there are too many images, do not spend time recomputing the extrinsic parameters twice..
