...
q=[0 0 0 0 0 -90]'*pi/180';
q=qreal2qsim(q,armnumber);
Tt_arm=fkine_M26(armparamsarr{1}.L,q)   %this Tt_arm represents the end-effector at the "zero" far-stretched arm position, we will calculate other positions based on this
...
Tt_ext1=calibparamsarr{camnumber}.HTc{14}; %index 10 is initial zero joint
...
%calculate the change in the position of the end effector.
 ...
 q2{14}=[0 0 0 0 0 -90]'*pi/180;
 q2{13}=[0 0 0 0 0 0]'*pi/180;
...
Tt_ext1=calibparamsarr{camnumber}.HTc{14};
...
q2{ii}=qreal2qsim(q2{ii},armnumber);
 ...
 Tt_arm_sim=fkine_M26(armparamsarr{1}.L,q2{ii})
...
Xend_can1=camextrinsic2armpos(TTcam,TTcamreference,TTarm)
...
%  [ Tt_arm_sim*xx1  Tt_arm_sim*xx2]
 ...
 % try
      'estimateq2'
 [estimateq2 isconverged]=ikine_M26(Tt_arm_sim,armparamsarr{1}.L,q)
   %end;try
       'estimateq2 by xend'
 [estimateq2_xend isconverged]=ikine_M26(Xend,armparamsarr{1}.L,q);
 ...
 try
 estimateXend=fkine_M26(armparamsarr{1}.L,estimateq2_xend)
...
delT=T2cartesian_real(Xend)-T2cartesian_real(Tt_arm)
 ...
 try
 J=jacob_M26(armparamsarr{1}.L,q2{ii})
